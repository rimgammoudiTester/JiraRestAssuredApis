package Bases.Asserts;

import io.restassured.response.Response;
import org.testng.Assert;

public class GenericAssertsCalls {
    /**
     * @author Rim Gammoudi
     */
    ...
    public  static void assertResponseStatus(int statusCode, Response res) {
    ...
    public static void assertParameterEqualToExpectedValue(Object expectedParameter, Response res, String path) {
    ...
    public  static void assertParameterEqualToExpectedValueByIterate(Object expectedParameter, Response res, String path, int i) {
    ...
    public static void assertParameterNotNull(Object expectedParameter) {
        Assert.assertNotNull(expectedParameter, "The parameter is Null");
    }

    //Methode useful For assert Response Status
    public static void assertParameterIsNull(Object expectedParameter) {
    ...
    public static boolean verifyTheTypeOfParameter(Response res, String path, int index, String type) {
    ...
    public static void assertTheTypeParameterIstrue(boolean completedParameter) {
